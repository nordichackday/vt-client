...
/***/ function(module, exports, __webpack_require__) {
	...
	var routes = _react2['default'].createElement(
	  ...
	  _react2['default'].createElement(Route, { path: '/', handler: _pagesStory2['default'] })
	);
	  ...
	  _createClass(Story, [{
	    ...
	    value: function render() {
	      return _react2['default'].createElement(
	        'div',
	        { className: 'story' },
	        _react2['default'].createElement(_componentsMediaViewer2['default'], null),
	        _react2['default'].createElement(_componentsTimeline2['default'], { entries: this.props.entries })
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(process) {/*global OpenLayers*/
	...
	if (process.browser) {
	  var _L = __webpack_require__(200);
	}
	...
	var Timeline = (function (_React$Component) {
	  ...
	  _createClass(Timeline, [{
	    ...
	    value: function render() {
	      ...
	      var entries = this.props.entries.map(function (entry, i) {
	        return _react2['default'].createElement(_entry2['default'], _extends({ parentHeight: _this2.state.height, parentScrollTop: _this2.state.scrollTop }, entry, { key: i }));
	      });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TimelineEntry = (function (_React$Component) {
	  ...
	  _createClass(TimelineEntry, [{
	    ...
	    value: function render() {
	      var className = 'timeline--entry';
	
	      // console.log('------- render timeline entry', this.state);
	
	      var offsetTop = this.state.offsetTop - this.props.parentScrollTop;
	      var offsetBottom = offsetTop + this.state.height;
