...
/***/ function(module, exports, __webpack_require__) {
	...
	var _pagesStory = __webpack_require__(197);
	
	var _pagesStory2 = _interopRequireDefault(_pagesStory);
	...
	var routes = _react2['default'].createElement(
	  Route,
	  { path: '/', handler: RouteHandler },
	  _react2['default'].createElement(Route, { path: '/timeline/:id', handler: _pagesStory2['default'] })
	);
	
	var initialData = JSON.parse($('#initial-data').html() || '{}');
	
	_reactRouter2['default'].run(routes, _reactRouter2['default'].HistoryLocation, function (Handler) {
	  _react2['default'].render(_react2['default'].createElement(Handler, initialData), document.querySelector('.page'));
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsMediaViewer = __webpack_require__(198);
	
	var _componentsMediaViewer2 = _interopRequireDefault(_componentsMediaViewer);
	
	var _componentsTimeline = __webpack_require__(201);
	...
	var Story = (function (_React$Component) {
	  function Story(props) {
	    ...
	    _get(Object.getPrototypeOf(Story.prototype), 'constructor', this).call(this, props);
	  ...
	  _createClass(Story, [{
	    key: 'handleActivateNode',
	    value: function handleActivateNode(id) {
	      this.setState({
	        mediaId: id
	      });
	    }
	    ...
	    value: function render() {
	      return _react2['default'].createElement(
	        'div',
	        { className: 'story' },
	        _react2['default'].createElement(_componentsMediaViewer2['default'], { mediaId: this.state.mediaId, nodes: this.props.nodes }),
	        _react2['default'].createElement(_componentsTimeline2['default'], { mediaId: this.state.mediaId, onActivateNode: this.handleActivateNode.bind(this), title: this.props.title, nodes: this.props.nodes })
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MediaViewer = (function (_React$Component) {
	  function MediaViewer(props) {
	    _classCallCheck(this, MediaViewer);
	
	    props = props || {};
	    _get(Object.getPrototypeOf(MediaViewer.prototype), 'constructor', this).call(this, props);
	  }
	  ...
	  _createClass(MediaViewer, [{
	    ...
	    value: function render() {
	      ...
	      var currNodes = this.props.nodes.filter(function (node) {
	        return +node.mediaId === +_this.props.mediaId;
	      });
	
	      var media = undefined;
	
	      if (currNodes.length) {
	        var nodeData = currNodes[0];
	        var nodeMedia = nodeData.media && nodeData.media.length ? nodeData.media[0] : {};
	        var type = nodeMedia.id || 1;
	        var data = nodeMedia.data || '{}';
	
	        switch (type) {
	          case 2:
	            // map
	            media = _react2['default'].createElement(_map2['default'], { data: data });
	            break;
	
	          case 1:
	            // image
	            media = _react2['default'].createElement(_image2['default'], { data: data });
	            break;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Map = (function (_React$Component) {
	  ...
	  _createClass(Map, [{
	    key: 'componentDidMount',
	    value: function componentDidMount() {
	      var data = JSON.parse('{"bounds": [[63.2270032,-24.3055935], [66.5336615,-13.0336209]]}');
	...
	var Image = (function (_React$Component) {
	  ...
	  _createClass(Image, [{
	    ...
	    value: function render() {
	      ...
	      var inlineStyle = { backgroundImage: 'url(' + data.originalUrl + ')' };
	
	      return _react2['default'].createElement('div', { className: 'media--image', style: inlineStyle });
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _entry = __webpack_require__(202);
	...
	var Timeline = (function (_React$Component) {
	  ...
	  _createClass(Timeline, [{
	    key: 'handleActivate',
	    value: function handleActivate(id) {
	      this.setState({
	        activeStoryId: id
	      });
	    ...
	    value: function render() {
	      ...
	      var nodes = this.props.nodes.map(function (node, i) {
	        return _react2['default'].createElement(_entry2['default'], _extends({
	          isActive: +node.mediaId === +_this.state.activeStoryId,
	          onActivate: _this.handleActivate.bind(_this),
	          parentHeight: _this.state.height,
	          parentScrollTop: _this.state.scrollTop }, node, {
	          key: i }));
	      });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TimelineEntry = (function (_React$Component) {
	  function TimelineEntry(props) {
	    _classCallCheck(this, TimelineEntry);
	
	    props = props || {};
	
	    _get(Object.getPrototypeOf(TimelineEntry.prototype), 'constructor', this).call(this, props);
	  ...
	  _inherits(TimelineEntry, _React$Component);
	
	  _createClass(TimelineEntry, [{
	    key: 'componentDidMount',
	    value: function componentDidMount(nextProps) {
	      var $el = window.jQuery(_react2['default'].findDOMNode(this));
	    ...
	    value: function render() {
	      ...
	      return _react2['default'].createElement(
	        'div',
	        { onClick: this.handleActivate.bind(this), className: className },
	        _react2['default'].createElement(
	          'div',
